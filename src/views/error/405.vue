<template>
  <div
    style="width: 1920px; height: 1080px; overflow: hidden; left: 0"
    class="col primaryColor primaryTextColor"
  >
    <div class="scene">
      <div class="forest">
    ...
    <div class="card">
      ...
      <div class="card-info">
        <span>404</span>
        <p @click="setColor">页面不存在，访问了未知路径</p>
      </div>
...
import { setTheme } from '@/assets/less/index.ts'
